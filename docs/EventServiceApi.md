...
//import io.swagger.client.api.EventServiceApi;
...
EventServiceApi apiInstance = new EventServiceApi();
...
> IoArgoprojWorkflowV1alpha1EventResponse eventServiceReceiveEvent(namespace, discriminator, body)
...
try {
    IoArgoprojWorkflowV1alpha1EventResponse result = apiInstance.eventServiceReceiveEvent(namespace, discriminator, body);
    System.out.println(result);
} catch (ApiException e) {
