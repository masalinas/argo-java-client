...
//import io.swagger.client.api.EventSourceServiceApi;
...
EventSourceServiceApi apiInstance = new EventSourceServiceApi();
...
> EventsourceEventSourceDeletedResponse eventSourceServiceDeleteEventSource(namespace, name, deleteOptionsGracePeriodSeconds, deleteOptionsPreconditionsUid, deleteOptionsPreconditionsResourceVersion, deleteOptionsOrphanDependents, deleteOptionsPropagationPolicy, deleteOptionsDryRun)
...
try {
    EventsourceEventSourceDeletedResponse result = apiInstance.eventSourceServiceDeleteEventSource(namespace, name, deleteOptionsGracePeriodSeconds, deleteOptionsPreconditionsUid, deleteOptionsPreconditionsResourceVersion, deleteOptionsOrphanDependents, deleteOptionsPropagationPolicy, deleteOptionsDryRun);
    System.out.println(result);
} catch (ApiException e) {
