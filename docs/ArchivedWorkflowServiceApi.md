...
> IoArgoprojWorkflowV1alpha1ArchivedWorkflowDeletedResponse archivedWorkflowServiceDeleteArchivedWorkflow(uid, namespace)
...
//import io.swagger.client.api.ArchivedWorkflowServiceApi;
...
ArchivedWorkflowServiceApi apiInstance = new ArchivedWorkflowServiceApi();
String uid = "uid_example"; // String | 
String namespace = "namespace_example"; // String | 
try {
    IoArgoprojWorkflowV1alpha1ArchivedWorkflowDeletedResponse result = apiInstance.archivedWorkflowServiceDeleteArchivedWorkflow(uid, namespace);
