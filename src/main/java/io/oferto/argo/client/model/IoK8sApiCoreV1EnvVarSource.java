...
import io.oferto.argo.client.model.IoK8sApiCoreV1ObjectFieldSelector;
import io.oferto.argo.client.model.IoK8sApiCoreV1ResourceFieldSelector;
...
public class IoK8sApiCoreV1EnvVarSource {
  ...
  **/
   ...
   * @return fieldRef
  **/
  @ApiModelProperty(value = "Selects a field of the pod: supports metadata.name, metadata.namespace, `metadata.labels['<KEY>']`, `metadata.annotations['<KEY>']`, spec.nodeName, spec.serviceAccountName, status.hostIP, status.podIP, status.podIPs.")
