...
import io.oferto.argo.client.model.IoK8sApiCoreV1Capabilities;
...
public class IoK8sApiCoreV1SecurityContext {
  ...
  **/
   ...
   * @return capabilities
  **/
  @ApiModelProperty(value = "The capabilities to add/drop when running containers. Defaults to the default set of capabilities granted by the container runtime. Note that this field cannot be set when spec.os.name is windows.")
  ...
  **/
  ...
  public IoK8sApiCoreV1SecurityContext runAsGroup(Integer runAsGroup) {
  ...
  **/
  ...
  public IoK8sApiCoreV1SecurityContext runAsUser(Integer runAsUser) {
  ...
  **/
  ...
  public IoK8sApiCoreV1SecurityContext seccompProfile(IoK8sApiCoreV1SeccompProfile seccompProfile) {
  ...
  **/
  @ApiModelProperty(value = "The seccomp options to use by this container. If seccomp options are provided at both the pod & container level, the container options override the pod options. Note that this field cannot be set when spec.os.name is windows.")
