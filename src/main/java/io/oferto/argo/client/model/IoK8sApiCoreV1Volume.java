...
import io.oferto.argo.client.model.IoK8sApiCoreV1AWSElasticBlockStoreVolumeSource;
import io.oferto.argo.client.model.IoK8sApiCoreV1AzureDiskVolumeSource;
import io.oferto.argo.client.model.IoK8sApiCoreV1AzureFileVolumeSource;
import io.oferto.argo.client.model.IoK8sApiCoreV1CSIVolumeSource;
import io.oferto.argo.client.model.IoK8sApiCoreV1CephFSVolumeSource;
import io.oferto.argo.client.model.IoK8sApiCoreV1CinderVolumeSource;
import io.oferto.argo.client.model.IoK8sApiCoreV1ConfigMapVolumeSource;
import io.oferto.argo.client.model.IoK8sApiCoreV1DownwardAPIVolumeSource;
import io.oferto.argo.client.model.IoK8sApiCoreV1EmptyDirVolumeSource;
import io.oferto.argo.client.model.IoK8sApiCoreV1EphemeralVolumeSource;
import io.oferto.argo.client.model.IoK8sApiCoreV1FCVolumeSource;
import io.oferto.argo.client.model.IoK8sApiCoreV1FlexVolumeSource;
import io.oferto.argo.client.model.IoK8sApiCoreV1FlockerVolumeSource;
import io.oferto.argo.client.model.IoK8sApiCoreV1GCEPersistentDiskVolumeSource;
import io.oferto.argo.client.model.IoK8sApiCoreV1GitRepoVolumeSource;
import io.oferto.argo.client.model.IoK8sApiCoreV1GlusterfsVolumeSource;
import io.oferto.argo.client.model.IoK8sApiCoreV1HostPathVolumeSource;
import io.oferto.argo.client.model.IoK8sApiCoreV1ISCSIVolumeSource;
import io.oferto.argo.client.model.IoK8sApiCoreV1NFSVolumeSource;
import io.oferto.argo.client.model.IoK8sApiCoreV1PersistentVolumeClaimVolumeSource;
import io.oferto.argo.client.model.IoK8sApiCoreV1PhotonPersistentDiskVolumeSource;
import io.oferto.argo.client.model.IoK8sApiCoreV1PortworxVolumeSource;
import io.oferto.argo.client.model.IoK8sApiCoreV1ProjectedVolumeSource;
import io.oferto.argo.client.model.IoK8sApiCoreV1QuobyteVolumeSource;
import io.oferto.argo.client.model.IoK8sApiCoreV1RBDVolumeSource;
import io.oferto.argo.client.model.IoK8sApiCoreV1ScaleIOVolumeSource;
import io.oferto.argo.client.model.IoK8sApiCoreV1SecretVolumeSource;
import io.oferto.argo.client.model.IoK8sApiCoreV1StorageOSVolumeSource;
import io.oferto.argo.client.model.IoK8sApiCoreV1VsphereVirtualDiskVolumeSource;
...
public class IoK8sApiCoreV1Volume {
  ...
  private IoK8sApiCoreV1EphemeralVolumeSource ephemeral = null;
  ...
  **/
   ...
   * @return csi
  **/
  @ApiModelProperty(value = "CSI (Container Storage Interface) represents ephemeral storage that is handled by certain external CSI drivers (Beta feature).")
  ...
  **/
  ...
  public IoK8sApiCoreV1Volume ephemeral(IoK8sApiCoreV1EphemeralVolumeSource ephemeral) {
   ...
   * @return ephemeral
  **/
  @ApiModelProperty(value = "Ephemeral represents a volume that is handled by a cluster storage driver. The volume's lifecycle is tied to the pod that defines it - it will be created before the pod starts, and deleted when the pod is removed.  Use this if: a) the volume is only needed while the pod runs, b) features of normal volumes like restoring from snapshot or capacity    tracking are needed, c) the storage driver is specified through a storage class, and d) the storage driver supports dynamic volume provisioning through    a PersistentVolumeClaim (see EphemeralVolumeSource for more    information on the connection between this volume type    and PersistentVolumeClaim).  Use PersistentVolumeClaim or one of the vendor-specific APIs for volumes that persist for longer than the lifecycle of an individual pod.  Use CSI for light-weight local ephemeral volumes if the CSI driver is meant to be used that way - see the documentation of the driver for more information.  A pod can use both types of ephemeral volumes and persistent volumes at the same time.")
  public IoK8sApiCoreV1EphemeralVolumeSource getEphemeral() {
    return ephemeral;
  }

  public void setEphemeral(IoK8sApiCoreV1EphemeralVolumeSource ephemeral) {
    this.ephemeral = ephemeral;
  }
